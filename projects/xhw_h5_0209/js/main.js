...
$('.swiper2_1 img').height($(window).height());
$('.swiper3_1 img').height($(window).height());
$('.swiper4_1 img').height($(window).height());
$('.swiper5_1 img').height($(window).height());
$('.swiper6_1 img').height($(window).height());
