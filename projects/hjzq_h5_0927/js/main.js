function loading(imgArr, callback) {
	...
	function _update() {
		...
		(percent>=20)&&$('.load .loading .load-circle img').attr('src','img/p0_4.png');
		(percent>=50)&&$('.load .loading .load-circle img').attr('src','img/p0_5.png');
		(percent>=80)&&$('.load .loading .load-circle img').attr('src','img/p0_6.png');
		if (percent == 100 && callback) {
			$('.load .loading .load-circle img').attr('src','../img/p0_7.png');
			$(".load").remove();
			callback();
		}
	}
...
function loadPage(next) {
	...
	if(next=='record1'){stopAudio_con();aUdio(0);}
	if(next=='record2'){stopAudio_con();aUdio(1);}
	if(next=='record3'){stopAudio_con();aUdio(2);}
...
// page2-4
$('#record1 .page-btn').on('click', function (e) {loadPage('letter');});
$('#record2 .page-btn').on('click', function (e) {loadPage('letter');});
$('#record3 .page-btn').on('click', function (e) {loadPage('letter');});
$('.record-btn1').on('click', function () {
	$('.record-btn1').addClass('btn-on');
	$('.record-btn2').removeClass('btn-on');
	$('.record-btn3').removeClass('btn-on');
	loadPage('record1');
});
$('.record-btn2').on('click', function () {
	$('.record-btn1').removeClass('btn-on');
...
var loadRES = ['img/icon/boc.png',
	'img/p0_1.png','img/p0_2.png','img/p0_3.png','img/p0_4.png','img/p0_5.png','img/p0_6.png','img/p0_7.png','img/p0_8.png',
	'img/p1_1.png','img/p1_2.png','img/p1_3.png','img/p1_4.png','img/p1_5.png','img/p1_6.png','img/p1_7.png','img/p1_8.png','img/p1_9.png','img/p1_10.png','img/p1_11.png','img/p1_12.png','img/p1_13.png',
