...
(function() {
   ...
   */
  function renderImageToDataURL(img, canvas, options, doSquash) {
   ...
   */
  MegaPixImage.prototype.render = function(canvas, options) {
    if (this.imageLoadListeners) {
      var _this = this;
      this.imageLoadListeners.push(function() { _this.render(canvas, options) });
      return;
    }
    options = options || {};
    ...
    if (tagName === 'img') {
      canvas.src = renderImageToDataURL(this.srcImage, opt, doSquash);
    } else if (tagName === 'canvas') {
      renderImageToCanvas(this.srcImage, canvas, opt, doSquash);
    }
