...
'img/bg0.jpg','img/bg1.jpg','img/bg2.jpg','img/bg8.jpg',
...
loading(loadRES, function(){
	...
	//链接
	$('.swiper10_2').on('click',function(){window.location.href="http://api.map.baidu.com/marker?location=27.942646,120.816076&title=理想之城售楼处&content=浙江省温州市龙湾区瓯海大道&output=html"});
	// 分享
