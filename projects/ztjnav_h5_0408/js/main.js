...
//链接
// $('.page-btn1').on('click',function(){window.location.href= "http://api.map.baidu.com/marker?location=30.338766,120.071884&title=中国铁建西湖国际城&content=浙江省杭州市西湖区祥余线&output=html"});
$('.page-btn1').on('click',function(){window.location.href= "https://www.amap.com/place/B0FFGYRD4N"});
$('.page-btn2').on('click',function(){window.location.href= "tel:0571-8588 0666"});
// 上滑
