...
// 链接
$('.swiper9_3').on('click',function(){window.location.href="tel:0575-84078888"});
$('.swiper9_4').on('click',function(){window.location.href="http://api.map.baidu.com/marker?location=30.039249,120.482511&title=高尔夫路与湖南路交叉口&content=湖南路和柯岩大道的交叉口附近&output=html"});
// 提交
