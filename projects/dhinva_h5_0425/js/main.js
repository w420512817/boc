...
// 链接
$('.swiper6_1').on('click',function(){window.location.href="http://api.map.baidu.com/marker?location=30.3078718,120.131249&title=杭州博采网络科技股份有限公司&content=莫干山路841弄23号中博文化创意园E座6层&output=html"});
$('.swiper6_4').on('click',function(){window.location.href="tel:0571-12341234"})
// 提交
...
'img/p1_1.png','img/p1_2.png','img/p1_3.png','img/p1_4.png','img/p1_7.png','img/p1_8.png','img/p1_9.png','img/p1_10.png',
'img/p2_1.png','img/p2_2.png','img/p2_3.png','img/p2_4.png',
'img/p3_1.png',
'img/p4_1.png','img/p4_2.png','img/p4_3.png','img/p4_4.png','img/p4_5.png','img/p4_6.png','img/p4_7.png','img/p4_8.png','img/p4_9.png',
...
'img/music2.png','img/arrow.png','img/next.png','img/bg1.jpg','img/bg2.jpg','img/bg5.jpg'
]
