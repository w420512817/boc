...
// 链接
$('.swiper-slide0').on('click', function(){
	$('.swiper0_2').css('animation','rotateOut 1s ease both');
...
'img/bg1.jpg','img/bg3.jpg','img/bg6.jpg','img/bg7.jpg','img/bg8.jpg',
'img/p0_1.png','img/p0_2.png','img/p0_3.png',
'img/p1_2.png','img/p1_3.png',
'img/p2_1.png','img/p2_2.png','img/p2_3.png','img/p2_4.png','img/p2_5.png','img/p2_6.png',
'img/p2_7.gif','img/p2_8.gif','img/p2_9.gif','img/p2_10.gif','img/p2_11.gif','img/p2_12.gif',
...
'img/music.png','img/next.png','img/lr.png',
]
loading(loadRES, function(){
	...
	var mySwiper = new Swiper('#swiper1', {
		...
		onSlideChangeEnd: function (swiper) {
			...
			$('#swiper1 .sw1>.swiper-slide').eq(swiper.activeIndex).addClass('enter').siblings().removeClass('enter');
			if (swiper.activeIndex == 8||swiper.activeIndex == 0||swiper.activeIndex == 1) {
				$('.resize').hide();
			} else {
				$('.resize').show();
			}
	...
	$('#swiper1 .sw1>.swiper-slide').eq(0).addClass('enter');
	//链接
