...
// });
// 点击
$('.swiper3_1').on('click',function(){
	audio_player.pause();
	$(".music").removeClass("on").addClass("off")
	stopAudio_con();
	aUdio(1);
	$(this).siblings('.black-box').find('img:nth-child(1)').attr('src','img/p3_3.png');
	$(this).siblings('.black-box').fadeIn();
});
$('.swiper3_2').on('click',function(){
	...
	stopAudio_con();
	aUdio(2);
	$(this).siblings('.black-box').find('img:nth-child(1)').attr('src','img/p3_4.png');
	$(this).siblings('.black-box').fadeIn();
});
$('.swiper4_1').on('click',function(){
	audio_player.pause();
	$(".music").removeClass("on").addClass("off")
	stopAudio_con();
	aUdio(3);
	$(this).siblings('.black-box').find('img:nth-child(1)').attr('src','img/p4_4.png');
	$(this).siblings('.black-box').fadeIn();
});
$('.swiper4_2').on('click',function(){
	audio_player.pause();
	$(".music").removeClass("on").addClass("off")
	stopAudio_con();
	aUdio(4);
	$(this).siblings('.black-box').find('img:nth-child(1)').attr('src','img/p4_5.png');
	$(this).siblings('.black-box').fadeIn();
});
$('.swiper4_3').on('click',function(){
	audio_player.pause();
	$(".music").removeClass("on").addClass("off")
	stopAudio_con();
	aUdio(5);
	$(this).siblings('.black-box').find('img:nth-child(1)').attr('src','img/p4_6.png');
	$(this).siblings('.black-box').fadeIn();
});
$('.swiper5_1').on('click',function(){
	audio_player.pause();
	$(".music").removeClass("on").addClass("off")
	stopAudio_con();
	aUdio(6);
	$(this).siblings('.black-box').find('img:nth-child(1)').attr('src','img/p5_3.png');
	$(this).siblings('.black-box').fadeIn();
});
$('.swiper5_2').on('click',function(){
	audio_player.pause();
	$(".music").removeClass("on").addClass("off")
	stopAudio_con();
	aUdio(7);
	$(this).siblings('.black-box').find('img:nth-child(1)').attr('src','img/p5_4.png');
	$(this).siblings('.black-box').fadeIn();
});
