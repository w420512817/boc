...
var animEndEventNames={'WebkitAnimation':'webkitAnimationEnd','OAnimation':'oAnimationEnd','msAnimation':'MSAnimationEnd','animation':'animationend'};var animEndEventName=animEndEventNames[Modernizr.prefixed('animation')];var support=Modernizr.cssanimations;function isAnimateend(element,callback){$(element).on(animEndEventName,function(){$(this).off(animEndEventName);callback()});if(!support){callback()}};
(function($) {  
    var old = $.fn.drag;  
        ...
        init: function() {  
            ...
            this.$element.on('touchstart.drag.founder mousedown.drag.founder', function(e) {  
                var ev = e.type == 'touchstart' ? e.originalEvent.touches[0] : e,  
                    ...
                    disX = ev.pageX - startPos.left - $("#fixed").offset().left,  
                    disY = ev.pageY - startPos.top - $("#fixed").offset().top,  
                    that = this;  
