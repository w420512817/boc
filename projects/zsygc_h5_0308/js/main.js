...
'img/music2.png','img/arrow.png','img/next.png','img/bg1.jpg','img/bg2.jpg','img/bg7.jpg','img/bg10.jpg'
]
loading(loadRES, function(){
	...
	//链接
	$('.swiper-slide10 .swiper10_3').on('click',function(){window.location.href="tel:0575-84078888"});
	$('.swiper-slide10 .swiper10_4').on('click',function(){window.location.href="http://api.map.baidu.com/marker?location=30.039249,120.482511&title=高尔夫路与湖南路交叉口&content=湖南路和柯岩大道的交叉口附近&output=html"});
	// 分享
