...
// 首页
/*
$('#welcome .welcome-list ').on('click', 'li:nth-child(2)', function () {window.location.href="registration.html";})
...
.on('click', 'li:nth-child(3)', function () {window.location.href="appointment_tea.html";})
/*
//page6 一键预约 样板房预约
...
$('#drinkbar-order .order-list .list-body p').on('click', '.list-info', function () {
	...
	if ($(this).parents('p').hasClass('active')) {
		...
		$('input[name="item"]:checked').each(function(){
			var thisNum = $(this).parents("p").find(".list-num").find("input").val();
			itemnums +=parseInt(thisNum);
		});
		if(parseInt(itemnums) >2){
			dialogueTips("单次饮品点单上限：3份");
			$(this).parents('p').toggleClass('active');
			return false;
		}
...
$('#drinkbar-order .order-list .list-body p .list-num').on('click', 'strong', function () {
	...
	if ($(this).html() == '-') {
		_num <= 1 ? _num : _num--;
		_num <= 1 ? itemnums : itemnums--;
	} else if ($(this).html() == '+') {
		_num++;
		itemnums++;
	}
	if(parseInt(itemnums) >3){
		dialogueTips("单次饮品点单上限：3份");
		return false;
	}
...
var loadRES = ['img/boc.png',
	...
	'img/p08_01.png', 'img/p08_02.png','img/p08_03.png', 'img/p08_04.png', 'img/p08_05.png', 'img/p08_06.png', 'img/p08_07.png', 'img/p08_08.png', 'img/p08_09.png', 'img/p08_10.png',
	'img/p08_11.png', 'img/p08_12.png','img/p08_13.png', 'img/p08_14.png', 'img/p08_15.png', 'img/p08_16.png', 'img/p08_17.png', 'img/p08_18.png', 'img/p08_19.png','img/p08_21.png',
