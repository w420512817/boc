...
// 一键导航
$('.swiper-slide8 .swiper8_7').on('click',function(){window.location.href="http://api.map.baidu.com/marker?location=28.148253,120.6813&title=浙江电大永嘉学院&content=永嘉县县前路&output=html"});
...
'img/p8_1.png','img/p8_2.png','img/p8_3.png','img/p8_4.png','img/p8_5.png','img/p8_6.png','img/p8_7.png','img/p8_8.png',
